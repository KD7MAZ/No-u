...
exports.run = async (client, message, args) => {
    ...
    let test2 = new Discord.RichEmbed()
        .setColor("#8F00FF")
        .setDescription(`**${message.author.username} Are you lucky?, Time to find out!** \n \n \n \n \n ●               ●`)
        setTimeout(function (){m.edit(test2)
        }, 500);

    let test3 = new Discord.RichEmbed()
        .setColor("#8F00FF")
        .setDescription(`**${message.author.username} Are you lucky?, Time to find out!** \n \n \n \n \n ●               ●               ● `)
        setTimeout(function (){m.edit(test3)
        }, 1000);

    let test4 = new Discord.RichEmbed()
        .setColor("#8F00FF")
        .setDescription(`**${message.author.username} Are you lucky?, Time to find out!** \n \n \n \n \n ●               ●               ●               ● `)
        setTimeout(function (){m.edit(test4)
        }, 1500);

    let test5 = new Discord.RichEmbed()
        .setColor("#8F00FF")     
        .setDescription(`**${message.author.username} Are you lucky?, Time to find out!** \n \n \n \n \n ●               ●               ●               ●               ● `)
        setTimeout(function (){m.edit(test5)
        }, 2000);
    ...
    let test6 = new Discord.RichEmbed()
        ...
        setTimeout(function (){m.edit(test6)
        }, 2500);
    ...
    let test7 = new Discord.RichEmbed()
        .setColor("#8F00FF")
        .setDescription(`**${message.author.username} Are you lucky?, Time to find out!** \n \n \n \n \n ●               ●`)
        setTimeout(function (){m.edit(test7)
        }, 500);

    let test8 = new Discord.RichEmbed()
        .setColor("#8F00FF")
        .setDescription(`**${message.author.username} Are you lucky?, Time to find out!** \n \n \n \n \n ●               ●               ● `)
        setTimeout(function (){m.edit(test8)
        }, 1000);

    let test9 = new Discord.RichEmbed()
        .setColor("#8F00FF")
        .setDescription(`**${message.author.username} Are you lucky?, Time to find out!** \n \n \n \n \n ●               ●               ●               ● `)
        setTimeout(function (){m.edit(test9)
        }, 1500);

    let test10 = new Discord.RichEmbed()
        .setColor("#8F00FF")     
        .setDescription(`**${message.author.username} Are you lucky?, Time to find out!** \n \n \n \n \n ●               ●               ●               ●               ● `)
        setTimeout(function (){m.edit(test10)
        }, 2000);
    ...
    let test11 = new Discord.RichEmbed()
        ...
        setTimeout(function (){m.edit(test11)
        }, 2500);
    }
