...
exports.run = (client, message, args) => {
    ...
    .setColor("#8F00FF")
    .addField("Commands For Moderator", `-warn -mute -unmute -kick -ban`)
    ...
    .addField("Note:", `If any of you start breaking the rules u will be demoted and possibly banned just because you are a mod doesnt mean you can go around provoking people and abusing your powers if i see this i will demote you.`)
